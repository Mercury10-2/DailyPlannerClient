            ...
            <v-sheet height="600">
                ...
                <v-menu v-model="selectedOpen" :close-on-content-click="false" :activator="selectedElement" offset-x>
                    <v-card color="grey lighten-4" min-width="350px" flat>
                        ...
                        <v-card-actions>
                            <v-btn text color="secondary" v-on:click="selectedOpen = false">Отмена</v-btn>
                        </v-card-actions>
                    </v-card>
                </v-menu>
            </v-sheet>
...
<script>
import Service from '../service/service.js'         //  Создавать и редактировать сообщения из календаря
export default {
    name: 'Calendar',
    data: () => ({
        focus: '',
